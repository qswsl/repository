...
<div class="wrapper wrapper-content animated fadeInRight">
    <a href="<%= request.getContextPath()%>/user/geren" class="btn btn-primary">返回</a>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                  <c:forEach items="${score}" var="list">
                        <tr>
                            <td></td>
                            <td>${list.be_team}</td>
                            <td>${list.name}</td>
