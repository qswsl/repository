...
<div class="container bs-docs-container" style="width:100%;">
    <div class="row">
        <form role="form" class="form-inline" action="<%= request.getContextPath()%>/user/shikuang" method="post"  id="formSubmit">
                            ...
                            <tobody>
                               <c:forEach items="${list}" var="list">
                                   <tr style="text-align:center;">
                                       ...
                                       <td><a href="<%= request.getContextPath()%>/user/shikuangcount?id=${list.id}" style="color: #00a2d4">实况录入</a></td>
                                   </tr>
                              </c:forEach>
                            </tobody>
                        </table>
