...
<div class="container bs-docs-container" style="width:100%;">
    <div class="row">
        <form role="form" class="form-inline" action="<%= request.getContextPath()%>/user/game" method="post"  id="formSubmit">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                       ...
                       <%-- <div class="search">
                        ...
                        <a href="<%= request.getContextPath()%>/user/addGame" class="btn btn-success">创建比赛</a>
                               ...
                               <c:forEach items="${list}" var="list">
                                   <tr style="text-align:center;">
                                      ...
                                      <%-- <td><a href="<%= request.getContextPath()%>/user/count?id=${list.id}" style="color: #00a2d4">技术统计</a></td>--%>
                                       <td><span style="color: #00a2d4" onclick="deleteId(${list.id})">删除</span>&nbsp;&nbsp;<a href="<%= request.getContextPath()%>/user/updateOneGame?id=${list.id}" style="color: #00a2d4">修改比赛</a></td>
                                   </tr>
                              </c:forEach>
                            </tobody>
                        </table>
