...
<div class="container bs-docs-container" style="width:100%;">
    <div class="row">
        <form role="form" class="form-inline" action="<%= request.getContextPath()%>/user/geren" method="post"  id="formSubmit">
                               ...
                               <c:forEach items="${list}" var="list">
                                   <tr style="text-align:center;">
                                      ...
                                      <%-- <td><a href="<%= request.getContextPath()%>/user/count?id=${list.id}" style="color: #00a2d4">技术统计</a></td>--%>
                                       <td><a href="<%= request.getContextPath()%>/user/count?id=${list.id}" style="color: #00a2d4">综合排名</a></td>
                                   </tr>
                              </c:forEach>
                            </tobody>
                        </table>
