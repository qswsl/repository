                ...
                <div class="ibox-content">
                    <form method="get" class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="playerName" value="${player.name}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="studentNumber" value="${player.student_number}">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="uniformNumber" value="${player.uniform_number}">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control m-b" name="account" id="age" value="${player.age}">
                                    <option>选择</option>
                                    <option>18</option>
                                    <option>19</option>
                                    <option>20</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="birth" class="form-control" id="birth" value="${player.date_birth}">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
...
<script>
    ...
    function addPlayer(){
        ...
        $.ajax({
            type: 'POST',
            url: '<%= request.getContextPath()%>/user/updatePlayerAdd',
            data: {"name": playerName,"student_number": studentNumber,"uniform_number": uniformNumber,"age": age,"date_birth": birth,"be_long_team": be_long_team,"sex":optionsRadios,"id":id},
            async: false,
            cache: false,
        });
