...
$(document).ready(function(){
	...
	turnplate.colors = ["#fff4dc", "#ffffff",
						"#fff4dc", "#ffffff",
						"#fff4dc", "#ffffff",
						"#fff4dc", "#ffffff",
						"#fff4dc", "#ffffff"];
	  ...
	  for(var i = 0; i < turnplate.restaraunts.length; i++) {
		...
		/*  if(text.indexOf("M")>0){//流量折扣券包
		  ...
		  if(text.indexOf("谢谢参与")>=0){
			  ...
			  img.onload=function(){
				   ctx.drawImage(img,-26,10,52,52);
				 
			  };
			  ctx.drawImage(img,-29,15,52,52);
